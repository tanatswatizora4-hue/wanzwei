  ...
  <DropdownPrimitive.Portal>
    <DropdownPrimitive.Content
      ...
      className={cn(
        ...
        "border-[color:var(--color-border-default)] text-[color:var(--color-ink-900)] wz-popover",
        className,
      )}
      {...props}
    />
...
>(({ className, inset, danger, ...props }, ref) => (
  <DropdownPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex min-h-11 cursor-pointer select-none items-center gap-2 rounded-[6px] px-2 py-2.5 text-sm outline-none transition-colors duration-150 sm:min-h-0 sm:py-1.5",
...
>(({ className, ...props }, ref) => (
  <DropdownPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[10rem] overflow-hidden rounded-[var(--radius-md)] border bg-white p-1 shadow-[var(--shadow-lg)] border-[color:var(--color-border-default)] wz-popover",
      className,
    )}
    {...props}
  />
